...
function getSpanishAlphabet() {
    ...
    let spanishAlphabet1 = spanishAlphabet.splice(3, 0, "ch");
    let spanishAlphabet2 = spanishAlphabet.splice(15, 0, "ñ");
    let spanishAlphabet3 = spanishAlphabet.splice(13, 0, "ll")
